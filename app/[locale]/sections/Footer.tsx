      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-4 max-md:grid-cols-1 gap-8 text-cream">
          ...
          <div>
            ...
            <p className="text-sm text-cream/80 mb-2">neama@gmail.com</p>
          ...
          <div className="w-fit">
            ...
            <ul className="space-y-2 text-cream/70 text-sm">
              {navLinks.slice(0, 4).map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="hover:text-cream transition">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div className="w-fit">
            ...
            <ul className="space-y-2 text-cream/70 text-sm">
              ...
              <li>
                <Link href="/track" className="hover:text-cream transition uppercase">
                  Track Order
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-cream transition uppercase">
                  Contact
                </Link>
              </li>
            </ul>
        ...
        <div className="flex max-md:flex-col max-md:items-center max-md:gap-4 justify-between items-center mt-12 text-cream/50 text-sm">
          ...
          <div className="flex gap-6 max-md:gap-4 flex-wrap max-md:justify-center">
            <Link href="/policies#privacy" className="hover:text-cream transition">
              Privacy Policy
            </Link>
            <Link href="/policies#terms" className="hover:text-cream transition">
              Terms
            </Link>
            <Link href="/policies#delivery" className="hover:text-cream transition">
              Shipping
            </Link>
            <Link href="/policies#refunds" className="hover:text-cream transition">
              Returns
            </Link>
          </div>
        </div>
