...
// FIXED: Import Link from next/link, not lucide-react
import Link from "next/link";
import ParallaxImage from "../components/ParallaxImage";

const About2 = () => {
  return (
    <section className="w-full relative bg-cream px-16 py-32 max-lg:pt-8 max-lg:px-8 max-md:px-5">
      ...
      <div className="flex flex-col items-center relative w-full max-w-[1440px] mx-auto h-full">
        <h1 className="font-serif text-[clamp(2.25rem,5.56vw,5rem)] text-center leading-none mt-32 bg-cream border-2 border-gold rounded-lg px-6 py-2 -rotate-2">
          Our <span className="italic">Story</span>
        </h1>

        <p className="text-[clamp(3rem,12vw,180px)] font-serif font-medium text-cream leading-none text-center mt-32">
          Born in <br /> India
        </p>

        <p className="font-serif text-[clamp(1.5rem,3.33vw,3rem)] mt-32 text-cream leading-[1.25] text-center ">
        ...
        {/* FIXED: Using next/link here */}
        <div className="w-full flex items-center justify-center mt-32 pb-16">
          <Link
            href="/about"
