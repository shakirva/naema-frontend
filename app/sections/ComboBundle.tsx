      ...
      <div className="bg-cream border-2 border-gold flex max-md:flex-col rounded-xl justify-between lg:py-20 py-12 px-8 max-lg:py-8 max-lg:px-6 gap-6">
        ...
        <div className="flex flex-col max-md:items-center flex-1">
          ...
          <div className="mt-auto flex gap-2 max-lg:mt-5 flex-wrap max-md:justify-center">
            <button className="text-center py-6 px-6 max-lg:px-4 max-lg:py-2.5 rounded-full font-medium tracking-tight text-sm bg-navy text-white border border-gold transition-all duration-200 cursor-pointer leading-none">
              Add bundle — $23.87
            </button>
            <button className="text-center  py-6 px-6  max-lg:px-4 max-lg:py-2.5 rounded-full border-gold border-2 bg-gold/40 font-medium tracking-tight text-sm transition-all duration-200 cursor-pointer leading-none">
              View Details
            </button>
          </div>
        </div>
