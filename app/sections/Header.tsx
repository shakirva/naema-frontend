  ...
  columns: [
    {
      ...
      handle: "dates",
      links: [
        { label: "View All Dates", href: "/shop/dates" },
      ],
    },
    {
      heading: "Nuts",
      handle: "nuts",
      links: [
        { label: "View All Nuts", href: "/shop/nuts" },
      ],
    },
    {
      heading: "Dry Fruits",
      handle: "dry-fruits",
      links: [
        { label: "View All Dry Fruits", href: "/shop/dry-fruits" },
      ],
    },
    {
      heading: "Chocolates",
      handle: "chocolates",
      links: [
        { label: "View All Chocolates", href: "/shop/chocolates" },
      ],
    },
  ],
  featured: [
...
const MegaMenu = ({ columns, featured }: {
  columns: typeof defaultMegaMenu.columns;
  featured: typeof defaultMegaMenu.featured;
}) => (
...
const Header = () => {
    ...
    const load = async () => {
      try {
        ...
        if (topLevel.length > 0) {
          const columns = topLevel.map((cat) => ({
            heading: cat.name,
            handle: cat.handle,
            links: [
              { label: `View All ${cat.name}`, href: `/shop/${cat.handle}` },
  ...
  return (
    <header className="w-full relative z-[9999]">
      ...
      >
        <MegaMenu columns={megaMenu.columns} featured={megaMenu.featured} />
      </div>
