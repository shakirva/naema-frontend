  ...
  return (
    <section className="w-full h-screen  bg-cream bg-center bg-cover ">
      <div className="flex mx-auto max-w-8xl h-full">
        ...
        <div className="w-1/2  text-black  flex flex-col items-center justify-center relative  ">
          <div className="h-full w-full absolute inset-0 opacity-25">
            <Image src="/palm.jpg" fill alt="palm" className=" object-cover " />
          </div>
          ...
          <div className="relative z-1 flex flex-col items-center  ">
            ...
            <span className="text-xs text-black/60 mt-2 leading-none ">
            ...
            <Link
              href={"/shop"}
              className="w-[200px] bg-navy text-white text-center font-medium tracking-tight px-6 py-4 leading-none  rounded-full uppercase mt-8 border-2 border-gold"
            >
              Shop Now
            </Link>
          </div>
