...
const testimonials = [
  ...
  {
    id: 2,
    quote: "Fresh, crunchy, and packed beautifully. You can really taste the quality.",
    author: "Rahul M.",
    rating: 5,
    bg: "bg-[#A7D56F]",
  },
  {
    id: 3,
    quote: "The perfect balance of texture and sweetness. My family finished it instantly.",
    author: "Sara H.",
    rating: 4,
    bg: "bg-[#F0C85F]",
  },
        ...
        <div className="mt-24 max-lg:mt-12 overflow-x-auto scrollbar-hide">
          <div className="flex gap-4 min-w-max pb-4">
            {testimonials.map((item) => (
              <div
                key={item.id}
                className={`w-[320px] h-[320px] rounded-[22px] border-2 shadow-sm border-gold flex flex-col items-center justify-center gap-5 p-8 ${item.bg}`}
              >
                {/* Stars */}
                ...
                <div className="flex items-center gap-2">
                  <div className="w-7 h-7 rounded-full bg-black/20 flex items-center justify-center text-black text-xs font-medium shrink-0">
